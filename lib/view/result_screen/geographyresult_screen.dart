...
class GeographyResultScreen extends StatelessWidget {
  ...
  const GeographyResultScreen({super.key, required this.rightAnsCount});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              "${rightAnsCount}/${Dummydb.geographyQuestions.length}",
              style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 25,
                color: Colors.amber,
  ...
  int _calculatePercentage() {
    print(rightAnsCount);
    double percentage =
        (rightAnsCount / Dummydb.geographyQuestions.length) * 100;
    print(percentage);
    if (percentage >= 80) {
      return 3;
