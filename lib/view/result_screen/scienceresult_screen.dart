...
class ScienceResultScreen extends StatelessWidget {
  ...
  const ScienceResultScreen({super.key, required this.rightAnsCount});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              "${rightAnsCount}/${Dummydb.scienceQuestion.length}",
              style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 25,
                color: Colors.amber,
  ...
  int _calculatePercentage() {
    print(rightAnsCount);
    double percentage = (rightAnsCount / Dummydb.scienceQuestion.length) * 100;
    print(percentage);
    if (percentage >= 80) {
      return 3;
